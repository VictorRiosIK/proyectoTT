...
function homePage() {
  ...
  return (
    <div className='abel-regular' >
      ...
      <div className='bg-white mb-5 p-1 rounded' >
      ...
      <h2 className='rounded p-1 fs-1 fw-bold text-white' style={{border: '2px solid white'}}>Información</h2>
      <div className="text-center w-100 bg-white  p-4 rounded-top " style={{border: '2px solid white'}}>
        <div className="row gap-4">
          <div className="col-sm bg-sky-700  rounded-top pt-4" >
            ...
            <div className='md:hidden bg-sky-700  rounded  pb-4'>
              {
      ...
      <div className='text-center w-100 bg-white  p-4 rounded-bottom  ' >
        <div className="row gap-4 ">
          <div className="col-sm bg-sky-700 rounded pt-4 fs-5 " >
